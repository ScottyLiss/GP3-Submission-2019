...
private:
	...
	std::unordered_map<std::string, std::shared_ptr<ShaderProgram>> m_shaderPrograms; // Shared pointer
	std::unordered_map<std::string, std::shared_ptr<Model>> m_models; // Shared Pointer 
	std::unordered_map<std::string, std::shared_ptr<Texture>> m_textures; // Shared pointer
